...
<head>
    ...
    <title>Stock Management Announcements | Admin Department</title>
...
<body>
    ...
    <?php include'main/header.php'; ?>
        ...
        <div class="page-header">
            <h1>Stock Management Announcements</h1>
        ...
        <div class="announcement-container">
            ...
            <div class="announcement-content">
                ...
                <p>The retreat will feature team-building activities, strategy sessions, and plenty of opportunities for relaxation and networking. Registration is now open through the Stock Management Portal until May 15th.</p>
