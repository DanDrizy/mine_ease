...
<head>
    ...
    <title>Stakeholder Announcements | Admin Department</title>
...
<body>
    ...
    <?php include'main/header.php'; ?>
        ...
        <div class="page-header">
            <h1>Stakeholder Announcements</h1>
        ...
        <div class="announcement-container">
            ...
            <div class="announcement-content">
                ...
                <p>The retreat will feature team-building activities, strategy sessions, and plenty of opportunities for relaxation and networking. Registration is now open through the Stakeholder Portal until May 15th.</p>
